            ...
            <div class="form-output">
                <form method="POST" action="">
                    <div class="form-group label-floating">
                        <label class="text-center font-weight-bold">Add City </label>
                    </div>
                    <div class="form-group label-floating">
                        <label class="control-label">City Name</label>
                        <input class="form-control" placeholder="" type="text" name="cityName">
                    </div>
                    <div class="form-group label-floating">
                        <input class="btn btn-success" type="submit" name="submit" id="clck" value="Add City">
                    </div>
...
?>
    <tr>
      <th><?php echo  $res['city_id'] ?> </th>
      <td><?php echo  $res['city_name'] ?></td>
      <td><a href="city_del.php?id=<?php echo  $res['city_id']?>"><button class="btn btn-danger">Delete</button></a></td>
    </tr>
<?php
  }
