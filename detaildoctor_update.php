...
<div class="content-wrapper">
        <div class="container-fluid overflow-hidden">
            <div class="row margin-tb-90px margin-lr-10px md-mrl-0px">
...
if(isset($_POST['submit'])){
    ...
    $query = "UPDATE `deataildoctor` SET `clinic`='$name',`address`='$address',`mon`='$mon',`tues`='$tues',`wed`='$wed',`thur`='$thur',`fri`='$fri',`sat`='$sat',`sun`='$sun' WHERE `doctor`='$email'";
