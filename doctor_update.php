...
if(isset($_POST['submit'])){
    ...
    $query = 	"UPDATE `doctor` SET `name`='$name',`email`='$email',`pass`='$pass',`gender`='$gender',`depart`='$depart',`city`='$city' WHERE `doctor_id`='$u_id'
    ";
    $LoginQuery = "UPDATE `login` SET `email`='$email',`pass`='$pass' where `login_id`='$u_id'";
